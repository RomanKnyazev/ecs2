...
> **Important! Its just PoC of "struct-based" version of [LeoECS](https://github.com/Leopotam/ecs) framework, not ready to use in production!**
...
ref Component2 c2 = entity.Set<Component2> ();
```
